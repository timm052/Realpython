...
# loop the dictionary will be acessed in it's hashed order
...
# NOTE it's important to use in statement as requexting a dictionary key
...
# dictionary values can be any object type (including other dictionarys)
...
# alternative ways to create dictionarys
# dict() can be used to create dictionarys where key names will only contain
# strings and numbers
